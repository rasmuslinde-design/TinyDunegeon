...
export default function CharSelectScreen() {
  ...
  const [selected, setSelected] = useState(player.charId ?? "mage");
  ...
  return (
    <div
      style={{
        ...
        inset: 0,
        background:
          "radial-gradient(ellipse at 50% 40%, #150a2e 0%, #0a0a0f 100%)",
        display: "flex",
    ...
    >
      ...
      <div style={{ display: "flex", gap: 12 }}>
        ...
        <button
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(168,85,247,0.35), rgba(100,50,200,0.45))",
