  ...
  return (
    <div
      style={{
        ...
        inset: 0,
        background:
          "radial-gradient(ellipse at 50% 60%, #1a0a2e 0%, #0a0a0f 100%)",
        display: "flex",
    ...
    >
      ...
      <div
        style={{
          ...
          color: "#fff",
          textShadow:
            "0 0 30px rgba(168,85,247,0.8), 0 2px 8px rgba(0,0,0,0.8)",
          marginBottom: 4,
          letterSpacing: 4,
      ...
      <button
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(168,85,247,0.3), rgba(100,50,200,0.4))",
        ...
        onMouseEnter={(e) => {
          e.target.style.background =
            "linear-gradient(135deg, rgba(168,85,247,0.5), rgba(100,50,200,0.6))";
