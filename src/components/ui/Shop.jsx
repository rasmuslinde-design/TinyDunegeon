...
const NPC_DIALOG = {
  merchant: { title: 'Merchant',  greeting: "Welcome, traveller! Browse my wares." },
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
          ...
          <button
            onClick={() => { onClose(); play('click'); }}
            style={{
              background: 'none', border: '1px solid #555',
              color: '#999', borderRadius: 4, padding: '2px 8px',
        ...
        {/* Greeting */}
        <div style={{
          color: '#aaa', fontSize: 10, marginBottom: 14,
          padding: '8px 10px',
        ...
        {/* Gold */}
        <div style={{ color: '#fbbf24', fontSize: 10, marginBottom: 10, textAlign: 'right' }}>
        ...
        {items.map(item => {
          ...
          const owned = item.type === 'weapon' && player.weapon?.id === item.weaponId;
          const unlocked = item.type === 'unlock' && player.inventory.some(i => i.charId === item.charId);
          ...
          return (
            <div key={item.id} style={{
              ...
              padding: '7px 10px',
              marginBottom: 6,
              background: owned || unlocked ? 'rgba(34,197,94,0.08)' : 'rgba(255,255,255,0.03)',
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                <span style={{ color: '#fbbf24', fontSize: 10 }}>💰{item.cost}</span>
                {owned || unlocked ? (
